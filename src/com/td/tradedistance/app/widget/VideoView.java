...
public class VideoView extends SurfaceView implements MediaPlayerControl {
    ...
    public void stopPlayback(String url) {
        if (mMediaPlayer != null) {
            mMediaPlayer.stop();
            mMediaPlayer.release();
            mMediaPlayer = null;
           //UserInfo.delProgress(mContext, oldname);
           // TDApp.manager.delPlayProgress(url);
        }
    }
    ...
    private void openVideo() {
        ...
        try {
            ...
            mIsPrepared = false;
            Logger.d(TAG, "reset duration to -1 in openVideo");
            mDuration = -1;
    ...
    MediaPlayer.OnVideoSizeChangedListener mSizeChangedListener =
        new MediaPlayer.OnVideoSizeChangedListener() {
            public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
                ...
                Logger.d("mVideoWidth", "mVideoWidth"+mVideoWidth);
                Logger.d("mVideoHeight", "mVideoHeight"+mVideoWidth);
