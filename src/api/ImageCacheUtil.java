...
import api.DiskLruCache.Snapshot;
...
public class ImageCacheUtil implements ImageCache {
    ...
    public ImageCacheUtil(Context context) {
        ...
        try {
            // 获取DiskLruCahce对象
           mDiskLruCache = DiskLruCache.open(getDiskCacheDir(context.getApplicationContext(), "xxxxx"), getAppVersion(context.getApplicationContext()), 1, DISKMAXSIZE);
